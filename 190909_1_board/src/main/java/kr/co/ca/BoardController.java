...
public class BoardController {
	...
	@RequestMapping("/read")
	public void read(Model model, int bno, PageTO to) throws Exception{
	...
	public String del(int bno, PageTO to) throws Exception {
	...
	public void modifyui(int bno, Model model, PageTO to) throws Exception{
	...
	public String modify(BoardVO vo, PageTO to) throws Exception{
